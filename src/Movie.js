  ...
  return (
    <>
      {movie ? (
        <div className="movie">
          <div className="movie_intro">
            <iframe
              ...
              src={
                "https://www.youtube.com/embed/" + movie[0].trailer + "?&mute=1"
              }
            ></iframe>
          </div>
          <div className="movie_detail">
            ...
            <div className="movie_detailRight">
              <div className="movie_detailRightTop">
                <div className="movie_name">{movie[0].title}</div>
                <div
                  className="movie_genres"
                  style={{ marginTop: "1rem", marginLeft: "15.5rem" }}
                >
                  {movie[0].genre.map((gen) => {
                ...
                <div
                  className="movie_cast"
                  style={{ marginTop: "1.5rem", marginLeft: "16rem" }}
                >
                ...
                <div
                  ...
                  style={{ marginTop: "1rem", marginLeft: "16rem" }}
                >
                  <span style={{ color: "white", fontSize: "1.5rem" }}>
                    Director:{" "}
                  </span>
        ...
        <div>{loading ? <Skeleton /> : <Error />}</div>
      )}
    </>
  );
}
