...
function AddCast(){
    ...
    return(
        <div className="add_Actordetails" style={{marginLeft: "2.5rem", marginTop: "6rem", color:"white" }}>
            ...
            < input type="text" id="name" name="name" placeholder="Actor's Name" onChange={handler} /><br />
            <label for="dob">BirthDate: </label><br/>
            < input type="date" placeholder="dob" id="dob" name="dob"  onChange={handler} style={{marginTop:"1rem", marginBottom:"1rem"}} /><br />
            <label for="description">Description: </label><br/>
            < input type="text"  id="description" placeholder="Actor's Description" name="description"  onChange={handler} /><br />
            <label for="image">Image: </label><br/>
            < input type="text" id="image" placeholder="Image Link" name="image" onChange={handler} /><br />
